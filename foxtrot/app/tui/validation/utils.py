...
def validate_symbol_format(symbol: str, exchange: Optional[str] = None) -> Tuple[bool, Optional[str]]:
    """
...
def validate_percentage(value: Any) -> Tuple[bool, Optional[Decimal], Optional[str]]:
    """
...
def parse_symbol_exchange(symbol_str: str) -> Tuple[str, Optional[str]]:
    """
