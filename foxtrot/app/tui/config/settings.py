...
class LayoutConfig:
    ...
    panels: List[str] = field(default_factory=lambda: [
        "trading", "tick", "order", "trade", "position", "account", "log"
    ])
...
class TUISettings:
    ...
    def _update_from_dict(self, data: Dict[str, Any]) -> None:
        ...
        try:
            ...
            # Simple settings
            for key in ["font_size", "show_title_bar", "show_status_bar", 
                       "show_clock", "confirm_orders", "double_click_trading", 
    ...
    async def migrate_from_qt(self, qt_settings_file: Optional[Path] = None) -> bool:
        """
        ...
        try:
            ...
            with open(qt_settings_file, 'r', encoding='utf-8') as f:
                qt_data = json.load(f)
    ...
    def get_color_scheme(self) -> ColorScheme:
        ...
        elif self.theme == TUITheme.TRADING_GREEN:
            return ColorScheme(
                background="black",
                text="green",
                border="green",
...
_settings_instance: Optional[TUISettings] = None
