...
class TUITickMonitor(TUIDataMonitor):
    ...
    def __init__(self, main_engine: MainEngine, event_engine: EventEngine, **kwargs: Any) -> None:
        ...
        """
        super().__init__(main_engine, event_engine, monitor_name="Tick Monitor", **kwargs)
        ...
        self.min_volume_filter: float | None = None
    ...
    def get_current_spread(self, vt_symbol: str) -> float | None:
        """
    ...
    def get_price_change(self, vt_symbol: str) -> float | None:
        """
