...
class OrderConfirmationDialog(BaseDialog):
    ...
    def __init__(
        ...
        **kwargs
        ...
        # UI components
        self.order_details_container: Optional[Container] = None
        self.risk_warning_widget: Optional[Static] = None
        self.funds_warning_widget: Optional[Static] = None
    ...
    def compose_content(self) -> list[Widget]:
        ...
        with Container(classes="order-details") as details_container:
            ...
            with Horizontal(classes="order-detail-row"):
                ...
                direction_color = self.color_manager.get_direction_color(self.order_data['direction'])
...
class CancelConfirmationDialog(BaseDialog):
    ...
    def __init__(
        ...
        **kwargs
        ...
        self.warning_widget: Optional[Static] = None
        self.order_info_widget: Optional[Static] = None
...
class CancelAllConfirmationDialog(BaseDialog):
    ...
    def __init__(
        ...
        **kwargs
        ...
        self.warning_widget: Optional[Static] = None
        self.message_widget: Optional[Static] = None
        self.count_widget: Optional[Static] = None
