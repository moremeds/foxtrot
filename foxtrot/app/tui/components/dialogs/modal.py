...
from .confirmation import OrderConfirmationDialog, CancelConfirmationDialog, CancelAllConfirmationDialog
...
_modal_manager: Optional[ModalManager] = None


def get_modal_manager(app: Optional[App] = None) -> ModalManager:
    """
