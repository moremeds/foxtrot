...
from foxtrot.util.utility import (
    ...
    get_icon_path, load_json, save_json, round_to, floor_to, ceil_to,
    get_digits, BarGenerator, ArrayManager, virtual, TRADER_DIR, TEMP_DIR
)
...
class TestBarGenerator:
    ...
    def create_test_tick(self, symbol="AAPL", exchange=Exchange.NYSE, 
                        price=100.0, volume=1000, datetime_obj=None):
    ...
    def test_update_tick_same_minute_updates_bar(self):
        ...
        tick2 = self.create_test_tick(price=102.0, volume=2000, datetime_obj=datetime(2023, 1, 1, 9, 30, 30))
...
class TestArrayManager:
    ...
    def create_test_bar(self, open_price=100, high_price=102, low_price=98, 
                       close_price=101, volume=1000, turnover=101000, 
                       open_interest=50):
    ...
    def test_array_properties(self):
        ...
        bar = self.create_test_bar(
            ...
            close_price=102, volume=1000, turnover=102000, 
            open_interest=50
        )
