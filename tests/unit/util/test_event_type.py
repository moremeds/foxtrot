...
from foxtrot.util.event_type import (
    ...
    EVENT_ACCOUNT, EVENT_QUOTE, EVENT_CONTRACT, EVENT_LOG, EVENT_TIMER
)
...
class TestEventTypeUsage:
    ...
    def test_event_type_string_operations(self):
        ...
        assert EVENT_TICK != EVENT_TICK.lower()
        assert EVENT_TICK != EVENT_TICK.upper()
...
class TestEventTypeEdgeCases:
    ...
    def test_event_type_immutability(self):
        ...
        assert EVENT_TICK == original_tick
    ...
    def test_event_type_hash_consistency(self):
        ...
        event_dict = {
            EVENT_TICK: "tick_data",
            EVENT_TRADE: "trade_data"
        }
